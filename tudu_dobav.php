...
$del=$_POST['delete'];
        ...
        if ($del!="")
        {
                ...
                <form method=post action='tudu_dobav.php'><fieldset title='Удалить'><INPUT TYPE=hidden NAME='deletex' VALUE='$del'><INPUT TYPE=submit VALUE=' ДА! '></fieldset></form>
                <form method=post action='form_zamech.php'><fieldset title='Не удалять'><INPUT TYPE=submit VALUE=' Отмена '></fieldset></form>
                </td></tr></table>
                ";
                exit;
        };
if ($deletex !="")
{
        ...
        //пишем delete-файл
        $delete =  fopen ("./tudu/delete$di$ech.csv","a");
        if(!$delete)
          {
