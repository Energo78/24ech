...
$check="checked";
 ...
 // форма:
 echo "
 <tr><td><form method=post action=tudu_save.php>
<SELECT NAME=stanc>
<OPTION>$str_exp[0] $kontr_punct
 ...
 <td>
 <textarea rows=4 name=date1 cols=10>$str_exp[3]</textarea>
 </td>
 <td><textarea rows=3 name=date2 cols=15>$str_exp[4]</textarea></td>
 <td>
 <textarea rows=4 name=otv cols=20>$str_exp[5]</textarea>
</td>
 <td>
