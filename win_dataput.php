...
fputs ( $file,"путь: $put1");fputs ( $file," ");
fputs ( $file,"$stanc");fputs ( $file," ");
fputs ( $file,"путь: $put2");fputs ( $file," ");
...
fputs ( $file,"$technica");fputs ( $file,"|");

fputs ( $file,"$proizvod");fputs ( $file,"|");
fputs ( $file,"$narnum");fputs ( $file,"|");

fputs ( $file,"$time5");fputs ( $file,":");
fputs ( $file,"$time6");fputs ( $file,"|");
fputs ( $file,"$time7");fputs ( $file,":");
fputs ( $file,"$time8");fputs ( $file,"|");
